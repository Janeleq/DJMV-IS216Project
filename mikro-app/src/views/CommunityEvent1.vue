<template>
  <div id="CommunityEvent1" class="container py-4 py-xl-5">
    <router-link to="/home">
      <i class="bx bx-arrow-back"></i>
    </router-link>

    <div class="card" style="font-size: 12px; height:;">
      <img class="card-img-top" src="../assets/ui/crypto_community.jpg" style="width: 100%; height: 50%"
        alt="Card image cap">
      <div class="card-body">
